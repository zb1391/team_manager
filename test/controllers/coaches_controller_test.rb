...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { email: @coach.email, encrypted_password: @coach.encrypted_password, first_name: @coach.first_name, last_name: @coach.last_name, phone: @coach.phone }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { email: @coach.email, encrypted_password: @coach.encrypted_password, first_name: @coach.first_name, last_name: @coach.last_name, phone: @coach.phone }
    assert_redirected_to coach_path(assigns(:coach))
  end
